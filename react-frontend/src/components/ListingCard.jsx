      ...
      <div className="relative bg-white rounded-3xl overflow-hidden">
        <Link to={`/listings/${listing.id}`}>
          <div className="relative h-56 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
            ...
            {/* Premium Price Badge */}
            <div className="absolute top-4 right-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-5 py-2.5 rounded-2xl text-base font-black shadow-2xl backdrop-blur-sm border-2 border-white/20 group-hover:scale-110 transition-transform duration-300">
              ₱{listing.price.toLocaleString()}
            </div>
            
            {/* Brand New Badge */}
            {listing.condition === 'brand_new' && (
              <div className="absolute top-4 left-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white px-4 py-2 rounded-xl text-xs font-bold shadow-2xl backdrop-blur-sm border-2 border-white/20 flex items-center space-x-1.5 group-hover:scale-110 transition-transform duration-300">
